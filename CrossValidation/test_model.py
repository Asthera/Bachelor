...
def test_model(model_path, test_data_path):
    ...
    network = resnet18(pretrained=ResNet18_Weights.DEFAULT)
    ...
    test_dataset = FramesDataset(test_data_path, test_data_path, init_transform, target_transform=None,
...
model_path = "weights/2024-03-19_14-38-42_epoch:5_run-id:jhb95v3s_val-loss:0.32888099551200867.pth"
